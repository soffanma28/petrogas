...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mb-2">{{ trans('backpack::base.register') }}</h3>
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-6 text-center"><a href="{{ route('backpack.auth.password.reset') }}" style="color: white">{{ trans('backpack::base.forgot_your_password') }}</a></div>
                @endif
                <div class="col-6 col-lg-6 text-center"><a href="{{ route('backpack.auth.login') }}" style="color: white">{{ trans('backpack::base.login') }}</a></div>
            </div>
        </div>
    </div>
@endsection
