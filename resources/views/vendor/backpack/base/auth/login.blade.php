    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-6 text-center text-white"><a href="{{ route('backpack.auth.password.reset') }}" style="color: white">{{ trans('backpack::base.forgot_your_password') }}</a></div>
                @endif
                @if (config('backpack.base.registration_open'))
                    <div class="col-6 col-lg-6 text-center"><a href="{{ route('backpack.auth.register') }}" style="color: white">{{ trans('backpack::base.register') }}</a></div>
                @endif
            </div>
        </div>
    </div>
