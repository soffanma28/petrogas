		    		...
		    		<div class="card">
		    			<div class="card-body">
		    				...
		    				<div class="form-group row">
		    					...
		    					<div class="col-sm-9">
		    						<select class="form-control select2" id="employee" name="employee[]" multiple="multiple" disabled>
		    				...
		    				<div class="form-group row">
							    ...
							    <div class="col-sm-9">
							    	<div class="input-group date" id="reqdatetimepicker">
								        <input type="datetime" class="form-control" id="req_date" name="req_date" value="{{$itemrequest->req_date->format('d F Y H:m:i')}}" disabled>
